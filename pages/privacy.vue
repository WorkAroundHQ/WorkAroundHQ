		...
		<div class="content">
			...
			<main>
				...
				<section class="privacyPolicy">
					...
					<p>You may revoke your prior consent to receive this newsletter under Art. 7 Para. 3 GDPR with future effect. All you have to do is inform us that you are revoking your consent.</p>

					<h4>Contact</h4>
					<p>If you contact us via email, the data you provide will be used for the purpose of processing your request. We must have this data in order to process and answer your inquiry; otherwise we will not be able to answer it in full or at all.</p>
					...
					<h4>Twitter</h4>
					<p>We maintain an online presence on Twitter to present our company and our services and to communicatewithcustomers/prospects. Twitter is a service provided by Twitter Inc., 1355 Market Street, Suite 900,San Francisco, CA94103, USA.</p>
					...
					<h4>GitHub</h4>
					<p>We maintain an online presence on GitHub to host repositories and our services and to communicate with customers/prospects. GitHub is a service provided by GitHub Inc., 88 Colin P Kelly Jr St, San Francisco, CA 94107, United States.</p>
					<p>We would like to point out that this might cause user data to be processed outside the European Union, particularly in the United States. This may increase risks for users that, for example, may make subsequent access to the user data more difficult. We also do not have access to this user data. Access is only available to GitHub.</p>
					<p>The privacy policy of GitHub can be found at</p>
					<p><a href="https://docs.github.com/en/github/site-policy/github-privacy-statement" target="_blank" rel="noopener">https://docs.github.com/en/github/site-policy/github-privacy-statement</a></p>

					<h4>TypeForm</h4>
					<p>We use TypeForm as a provider to do user researches and to do handle newsletter subscriptions. TypeForm is a service provided by Typeform S.L., Carrer de Bac de Roda, 163, 08018 Barcelona, Spain.</p>
					<p>We would like to point out that this might cause user data to be processed outside the European Union, particularly in the United States. This may increase risks for users that, for example, may make subsequent access to the user data more difficult. We also do not have access to this user data. Access is only available to TypeForm.</p>
					<p>The privacy policy of TypeForm can be found at</p>
					<p><a href="https://admin.typeform.com/to/dwk6gt" target="_blank" rel="noopener">https://admin.typeform.com/to/dwk6gt</a></p>

					<h4>Airtable</h4>
					<p>We use Airtable to store E-Mail addresses for our newsletter. Airtable is a service provided by Formagrid, Inc., 155 5th St 6th Floor, San Francisco, CA 94103, United States.</p>
					<p>We would like to point out that this might cause user data to be processed outside the European Union, particularly in the United States. This may increase risks for users that, for example, may make subsequent access to the user data more difficult. We also do not have access to this user data. Access is only available to Airtable.</p>
					<p>The privacy policy of Airtable can be found at</p>
					<p><a href="https://airtable.com/privacy" target="_blank" rel="noopener">https://airtable.com/privacy</a></p>
					...
					<p>Privacy Policy: <a href="https://docs.github.com/en/github/site-policy/github-privacy-statement" target="_blank" rel="noopener">https://docs.github.com/en/github/site-policy/github-privacy-statement</a></p>
